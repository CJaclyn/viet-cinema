  ...
  return (
    <div className='page page-movies'>
      ...
      <main>
        ...
        <FilterForm data={genres} router={router} pageName='movies' />
...
export async function getServerSideProps({
  ...
  const showsData = await fetchAPI(
    `shows?sort[0]=release_date:desc&pagination[pageSize]=25&pagination[page]=${page}&filters[genres][genre][$eq]=${filter}&populate=*`
  );
